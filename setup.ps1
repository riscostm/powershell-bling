...
if (!(Test-Path -Path $PROFILE -PathType Leaf)) {
    try {
        ...
        Invoke-RestMethod https://github.com/riscostm/powershell-bling/blob/921c3f86280ff27ea1c74da71cee6c9e411abcfd/Microsoft.PowerShell_profile.ps1 -OutFile $PROFILE
